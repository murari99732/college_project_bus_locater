<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllRoutes.aspx.cs" Inherits="BusArriaval.AllRoutes" %>
                    ...
                    <div class="fields">
                        ...
                        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <a href="AddRoutes.aspx">Add Routes</a>
                                    <asp:Label ID="lblStatus" runat="server" Text="" ForeColor="Red"></asp:Label>
                                    <asp:GridView ID="GridRoutes" runat="server" DataKeyNames="Id" AutoGenerateColumns="false">
                                        <Columns>
                                             <asp:BoundField DataField="Route" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Route" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
                                            <asp:BoundField DataField="Source" HeaderStyle-HorizontalAlign="Left" HeaderText="Source"
                                                ItemStyle-HorizontalAlign="Left" />
                                            <asp:BoundField DataField="Destination" HeaderStyle-HorizontalAlign="Left" HeaderText="Destination"
                                                ItemStyle-HorizontalAlign="Left"></asp:BoundField>
                                            <asp:BoundField DataField="Number" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Number" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
                                            <asp:TemplateField>
