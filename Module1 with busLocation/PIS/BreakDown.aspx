<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BreakDown.aspx.cs" Inherits="BusArriaval.BreakDown" %>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <asp:GridView ID="GridBuses" runat="server" DataKeyNames="Id" AutoGenerateColumns="false">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Time" HeaderStyle-HorizontalAlign="Left" HeaderText="Time of BreakDown"
                                                ...
                                                <asp:TemplateField>
                                                 ...
                                                 <asp:TemplateField>
                                                    ...
                                                    <ItemStyle HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkDelete" CommandArgument='<%# Eval("Id")%>' OnClick="lnkDelete_Click" runat="server">Mark Repaired</asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
